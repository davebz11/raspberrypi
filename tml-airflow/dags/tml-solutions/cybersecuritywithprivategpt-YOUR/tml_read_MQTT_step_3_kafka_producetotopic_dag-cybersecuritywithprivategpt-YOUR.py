...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_cybersecuritywithprivategpt-YOUR", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_cybersecuritywithprivategpt-YOUR"], schedule=None,catchup=False)
...
def mqttserverconnect():
 ...
 if 'MQTTUSERNAME' in os.environ:
       username = os.environ['davebz']  
 if 'MQTTPASSWORD' in os.environ:
       password = os.environ['Marley27']  
