...
default_args = {
  'topic' : 'iot-preprocess,iot-ml-prediction-results-output',    # <<< *** Separate multiple topics by a comma - Viperviz will stream data from these topics to your browser
  'dashboardhtml': 'iot-failure-machinelearning.html', # <<< *** name of your dashboard html file  try: iot-failure-seneca.html
...
@dag(dag_id="tml_system_step_7_kafka_visualization_dag_myawesometmlsolutionml-6656", default_args=default_args, tags=["tml_system_step_7_kafka_visualization_dag_myawesometmlsolutionml-6656"], schedule=None,catchup=False)
def startstreaming():    
  def empty():
      pass
dag = startstreaming()
