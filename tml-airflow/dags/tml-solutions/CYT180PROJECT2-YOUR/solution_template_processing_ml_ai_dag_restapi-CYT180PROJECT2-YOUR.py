...
step1 = importlib.import_module("tml-solutions.CYT180PROJECT2-YOUR.tml_system_step_1_getparams_dag-CYT180PROJECT2-YOUR")
step2 = importlib.import_module("tml-solutions.CYT180PROJECT2-YOUR.tml_system_step_2_kafka_createtopic_dag-CYT180PROJECT2-YOUR")
step3 = importlib.import_module("tml-solutions.CYT180PROJECT2-YOUR.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-CYT180PROJECT2-YOUR")
step4 = importlib.import_module("tml-solutions.CYT180PROJECT2-YOUR.tml_system_step_4_kafka_preprocess_dag-CYT180PROJECT2-YOUR")
step5 = importlib.import_module("tml-solutions.CYT180PROJECT2-YOUR.tml_system_step_5_kafka_machine_learning_dag-CYT180PROJECT2-YOUR")
step6 = importlib.import_module("tml-solutions.CYT180PROJECT2-YOUR.tml_system_step_6_kafka_predictions_dag-CYT180PROJECT2-YOUR")
step7 = importlib.import_module("tml-solutions.CYT180PROJECT2-YOUR.tml_system_step_7_kafka_visualization_dag-CYT180PROJECT2-YOUR")
step8 = importlib.import_module("tml-solutions.CYT180PROJECT2-YOUR.tml_system_step_8_deploy_solution_to_docker_dag-CYT180PROJECT2-YOUR")
step9 = importlib.import_module("tml-solutions.CYT180PROJECT2-YOUR.tml_system_step_9_privategpt_qdrant_dag-CYT180PROJECT2-YOUR")
step10 = importlib.import_module("tml-solutions.CYT180PROJECT2-YOUR.tml_system_step_10_documentation_dag-CYT180PROJECT2-YOUR")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-CYT180PROJECT2-YOUR",
