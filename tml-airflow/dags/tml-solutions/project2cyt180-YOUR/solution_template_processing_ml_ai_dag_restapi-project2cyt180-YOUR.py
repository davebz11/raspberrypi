...
step1 = importlib.import_module("tml-solutions.project2cyt180-YOUR.tml_system_step_1_getparams_dag-project2cyt180-YOUR")
step2 = importlib.import_module("tml-solutions.project2cyt180-YOUR.tml_system_step_2_kafka_createtopic_dag-project2cyt180-YOUR")
step3 = importlib.import_module("tml-solutions.project2cyt180-YOUR.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-project2cyt180-YOUR")
step4 = importlib.import_module("tml-solutions.project2cyt180-YOUR.tml_system_step_4_kafka_preprocess_dag-project2cyt180-YOUR")
step5 = importlib.import_module("tml-solutions.project2cyt180-YOUR.tml_system_step_5_kafka_machine_learning_dag-project2cyt180-YOUR")
step6 = importlib.import_module("tml-solutions.project2cyt180-YOUR.tml_system_step_6_kafka_predictions_dag-project2cyt180-YOUR")
step7 = importlib.import_module("tml-solutions.project2cyt180-YOUR.tml_system_step_7_kafka_visualization_dag-project2cyt180-YOUR")
step8 = importlib.import_module("tml-solutions.project2cyt180-YOUR.tml_system_step_8_deploy_solution_to_docker_dag-project2cyt180-YOUR")
step9 = importlib.import_module("tml-solutions.project2cyt180-YOUR.tml_system_step_9_privategpt_qdrant_dag-project2cyt180-YOUR")
step10 = importlib.import_module("tml-solutions.project2cyt180-YOUR.tml_system_step_10_documentation_dag-project2cyt180-YOUR")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-project2cyt180-YOUR",
