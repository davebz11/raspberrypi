...
step1 = importlib.import_module("tml-solutions.myawesometmlsolutionml-YOUR.tml_system_step_1_getparams_dag-myawesometmlsolutionml-YOUR")
step2 = importlib.import_module("tml-solutions.myawesometmlsolutionml-YOUR.tml_system_step_2_kafka_createtopic_dag-myawesometmlsolutionml-YOUR")
step3 = importlib.import_module("tml-solutions.myawesometmlsolutionml-YOUR.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-myawesometmlsolutionml-YOUR")
step4 = importlib.import_module("tml-solutions.myawesometmlsolutionml-YOUR.tml_system_step_4_kafka_preprocess_dag-myawesometmlsolutionml-YOUR")
step5 = importlib.import_module("tml-solutions.myawesometmlsolutionml-YOUR.tml_system_step_5_kafka_machine_learning_dag-myawesometmlsolutionml-YOUR")
step6 = importlib.import_module("tml-solutions.myawesometmlsolutionml-YOUR.tml_system_step_6_kafka_predictions_dag-myawesometmlsolutionml-YOUR")
step7 = importlib.import_module("tml-solutions.myawesometmlsolutionml-YOUR.tml_system_step_7_kafka_visualization_dag-myawesometmlsolutionml-YOUR")
step8 = importlib.import_module("tml-solutions.myawesometmlsolutionml-YOUR.tml_system_step_8_deploy_solution_to_docker_dag-myawesometmlsolutionml-YOUR")
step9 = importlib.import_module("tml-solutions.myawesometmlsolutionml-YOUR.tml_system_step_9_privategpt_qdrant_dag-myawesometmlsolutionml-YOUR")
step10 = importlib.import_module("tml-solutions.myawesometmlsolutionml-YOUR.tml_system_step_10_documentation_dag-myawesometmlsolutionml-YOUR")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-myawesometmlsolutionml-YOUR",
